...
import aboutImage from  "../assets/news-letter-bg.png"
...
const AboutUs = () => {
  return (
    ...
    <div style={{ maxWidth: "100vw" ,paddingTop:"72px"}}>
      ...
      >
        <div
          className="w-100 h-100 py-5 px-7 z-2 d-md-block d-flex flex-wrap "
          style={{ backgroundColor: "rgba(128, 114, 113,0.4)", lineHeight:1.1, minHeight:"245px" }}
        >
          <p className=" fw-max fs-max text-uppercase ">About Us</p>
        </div>
      </div>
      <div className="row m-0 p-0">
        <div className="col-md-6 col-12 py-0 px-0 ownerPic" style={{ backgroundImage:`url(${aboutImage})`, backgroundPosition: "center",
          backgroundSize: "cover",
          backgroundRepeat: "no-repeat",
          minHeight:"480px"
           }}>
            <div className="d-flex flex-column align-items-center justify-content-center h-100 " >
              <div className="py-3" style={{ backgroundColor:"rgba(255,255,255,0.1)", width:"100%", textAlign:"center",lineHeight:1.2}}>
              <span className="fs-max fw-bold">MUSTAN ALI</span>
              <span className="fs-max fw-bold d-block">CEO</span>

              </div>
            </div>
           </div>
        <div className="col-md-6 col-12 p-md-5 py-5 ourStory">
          <span className="fs-1 fw-max ">OUR STORY</span>
          <p className="my-4" style={{fontWeight:500}}>
            Located in Sydney Australia, Mustan Painting and Decorating is a family-run
            ...
            painting services to homes and businesses in Sydney Australia.
          </p>
