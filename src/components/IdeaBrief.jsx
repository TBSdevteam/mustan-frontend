...
const IdeaBrief = () => {
  ...
  useEffect(() => {
    ...
    const target = document.getElementById("IdeaBriefSection");
    if (target) {
  ...
  return (
    <div
      className=" row pt-5 m-0 IdeaBriefContainer " id="IdeaBriefSection"
      style={{ paddingLeft: "70px" }}
    >
      <div className="col-md-7 col-12 IdeaBriefHead" style={{ padding: "0px 80px 60px 0px" }}>
        <p className="fs-max fw-bold text-uppercase" style={{ lineHeight: 1.1 }}>
          From small touch-ups to large-scale projects, we&apos;ve got you
          covered!
        </p>
        <p className="mb-0" style={{ lineHeight:1.4, fontWeight:500, fontSize:"18px" }}>
          Located in Sydney Australia, Mustan Painting & Decorating is a family-owned business
          ...
          businesses across Sydney Australia. We prioritize excellent client care
      ...
      <div className="col-md-5 col-12 p-0 m-0 d-flex flex-column justify-content-between ">
        {logoAnimation && <div className="col-12 d-flex justify-content-md-center pt-md-4 ps-md-0 ps-6 mb-md-0 mb-5 scale-up-hor-right">
          <img src={Logo} alt="logo" height={180} width={200} />
        </div>}
        {logoAnimation && <div className="col-12 scale-up-hor-left-fast" onClick={()=>navigate("/contact")}>
          <div
